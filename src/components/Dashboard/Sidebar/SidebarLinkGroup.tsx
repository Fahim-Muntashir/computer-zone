                ...
                <ul className="flex flex-col py-4 space-y-1">
                    ...
                    <li className="z-10">
                        <div
                            ...
                            className="relative flex flex-row items-center z-40 h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 cursor-pointer"
                        >
                            <span className="inline-flex justify-center items-center ml-4">
                                <FaStore />
                            ...
                            <span className="px-2 py-0.5 ml-auto text-xs font-medium tracking-wide text-red-500 bg-red-50 rounded-full">Manage</span>
                        </div>
                        {/* Dropdown content */}
                        {isDropdownOpen && (
                            <ul className="absolute  py-2 w-full bg-white rounded shadow-lg">

                                <li >
                                    <Link className="px-4 py-1 text-gray-700 hover:bg-gray-100 cursor-pointer flex items-center ps-10 gap-3 font-light" to="/dashboard/additem">
                                        <IoBagAddOutline />
                    ...
                    <li>
                        <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            ...
                            <span className="ml-2 text-sm tracking-wide truncate">Messages
                            </span>
                        </a>
                    </li>
                    <li>
