...
const Login = () => {
    ...
    return (
        <div className="flex my-10 w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            <div className="hidden bg-cover lg:block lg:w-1/2" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1602837385569-08ac19ec83af?q=80&w=1852&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')" }}></div>
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mt-6">
                        <input type='submit' value={"Sign In"} className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50 cursor-pointer" />
                    </div>
                </form>
